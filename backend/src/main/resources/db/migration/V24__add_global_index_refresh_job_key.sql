...
ALTER TABLE admin_trigger
    ADD CONSTRAINT ck_admin_trigger_timeframe_requirements
        CHECK (
            ...
            OR (job_key IN ('TRADING_DAY_PARAM_REFRESH', 'MARKET_SENTIMENT_REFRESH', 'GLOBAL_INDEX_REFRESH')
...
ALTER TABLE admin_trigger
    ADD CONSTRAINT ck_admin_trigger_bootstrap_requirements
        CHECK (
            ...
            OR job_key IN ('TRADING_SIGNAL_REFRESH', 'TRADING_DAY_PARAM_REFRESH', 'MARKET_SENTIMENT_REFRESH', 'GLOBAL_INDEX_REFRESH')
        );
